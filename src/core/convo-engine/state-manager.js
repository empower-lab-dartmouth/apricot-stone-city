...
var safelyGetConvoSegment = function (rootModule, path, currentPath) {
    var unsafeRetreive = function (path) {
        ...
        var reducer = function (parentModule, nextChildId) {
            return parentModule.submodules[(0, util_functions_1.getNominalValue)(nextChildId)];
        };
    ...
    return (0, Either_1.tryCatch)(function () { return unsafeRetreive(path); }, function (e) {
        return e instanceof Error
            ? new Error("Module path is invalid: ".concat(path))
            : new Error('Unknown error while retreiving convo segment');
    });
};
exports.safelyGetConvoSegment = safelyGetConvoSegment;
...
var getCurrentConvoSegment = function (rootModule, navigationStoreFunctions) {
    ...
    var currentConvoSegmentOrError = (0, exports.safelyGetConvoSegment)(rootModule, currentPath, currentPath);
    ...
    var folding = (0, Either_1.fold)(errorHandling, function_1.identity);
...
var stateNavigationFunctionsConstructor = function (rootModule, navigationStoreFunctions) {
    return {
        safelyGetConvoSegment: function (path) {
            return (0, exports.safelyGetConvoSegment)(rootModule, path, navigationStoreFunctions.getCurrentConvoSegmentPath());
        },
