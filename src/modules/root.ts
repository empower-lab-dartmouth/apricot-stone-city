...
const root = make.module({
   id: 'root',
   submodules: [nestedModule, carolArrivesAtASC,NormanLearnsAboutGradientDescent,normanArrivesAtASC,normanLearnsKMeans,normanLearnsAboutTrainingData,normancreatespell,NormanNeuralNetwork],
   convoSegments: [
       {
           id: '/start',
           convo: [
               {
                   type: 'text',
                   text: 'Welcome to Apricot Stone City, an interactive storytelling game about life in Yerevan, machine learning, and free will.\n\n Before we continue, is this a new account, or is there a different person playing from this account?',
               },
              
           ],
           choices: [
               {
                   text: 'Yes, it is my first time or someone else was playing before',
                   logic: [
                       {
                           do: [
                               {
      ...
      
       {
           ...
           choices: [
               {
                   text: 'please input text on your keyboard, ignore this button',
                   logic: [
           ...
           default: [
               {
                   if: state => state.lastTextMessage == 'please input text on your keyboard, ignore this button' ,
                   do: [
                       {
                           type: 'goto',
                           path: ['enter-again'],
       ...
       },
       {
           ...
           convo: [
               {
                   type: 'text',
                   text: state => `Thanks you entered ${state.username} as your name, is it correct?`,
               },
           ],
           choices: [
               {
       ...
       },
       {
           ...
           convo: [
               {
                   type: 'text',
                   text: 'Please enter your real name, and dont use the buttons, use the keyboard instead!',
               },
           ],
           choices: [
               {
       ...
       },
       {
           ...
           convo: [
               {
                   type: 'text',
                   text: state => `Thanks you entered ${state.userEmail} as your email, is it correct?`,
               },
           ],
           choices: [
               {
       ...
       },
       {
           ...
           convo: [
               {
                   type: 'text',
                   text: state => `One more thing ${state.username}. Remember, you can always suggest new buttons that should be added by just typing them. We'll use that data to keep building out that game :)`,
               },
           ],
           choices: [
               {
