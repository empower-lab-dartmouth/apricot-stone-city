...
const exploringATC = make.module({
    ...
    convoSegments: [
        ...
        },
        {
            ...
            convo: [{
                type: 'text',
                text: '"Heck no! I\'m already drenched and I don\'t have any spare clothes! How can you be so inconsiderate! I lost my baggage! I lost my passport! You know what?! Go to hell, Leo! You are definitely not as nice as I thought you were!!!" <b>Carol yells and pushes him on the grown.</b>\n\nShe walks along the wet pavement...'
            }],
            choices: [ ],
        }
    ],
