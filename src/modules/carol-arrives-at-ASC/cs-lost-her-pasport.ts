  ...
  convoSegments: [
    ...
    },
    {
      ...
      convo: [
        {
          type: 'text',
          text: 'Carol arrives at the cafe with the intensions of getting her head clear of all the stress she encountered today And also at the same time she can try to communicate with the locals , she tries to kill two birds with one stone. At the cafe she sees locals and Carol tries to communicate with them but she is unsuccessful because the locals don\'t speak her language. Through the pressure she gets angry and frustrated and decides to leave the cafe.',
        },
      ],
      choices: [{
    ...
    },
    {
      ...
      convo: [
        {
          type: 'text',
          text: 'She\'s not sure where she\'s going, she\'s just upset. Carol is soaking wet after just a few blocks. It\'s pouring. She is walking and only negative thoughts are circulating in her head about why everything was so badly arranged.',
        },
      ],
      choices: [{
        text: '',
