  ...
  convoSegments: [
    {
      ...
      convo: [
        {
          type: 'text',
          text: '<b>It is raining heavily. Carol is wet and frustrated. She does not know where she is. A car stops and the driver is an old-looking woman looks out of the window.</b>',
        },
      ],
      choices: [{
    ...
    },
   {
    ...
    },
    {
      ...
      convo: [
        {
          type: 'image',
          src: 'https://previews.123rf.com/images/tixti/tixti1502/tixti150201475/36865186-young-handsome-man-with-umbrella-posing-in-the-rain.jpg'
        },
      ],
      choices: [{
        text: 'What happened next?',
