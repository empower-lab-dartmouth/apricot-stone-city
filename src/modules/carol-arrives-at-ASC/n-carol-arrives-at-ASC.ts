...
const carolArrivesAtASC = make.module({
  ...
  submodules: [onThePlane, missingBag, toughestNutInTown,aWomanStopsHerCar,CarolArrivesAtCascade,atTheWarmHouse,carolGoesToBed,stopsTaxi,havingDinner,exploringATC,lostPasport,solemWalk],
  convoSegments: [],
});
